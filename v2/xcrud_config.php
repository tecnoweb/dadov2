<?php 
/**
 * xCrudRevolution Configuration File
 * 
...
class Xcrud_config
{
    ...
    public static $dbtype = 'mysql'; // Database type: mysql, postgresql, sqlite
    public static $dbname = 'dadov2'; // Your database name
    public static $dbuser = 'dado'; // Your database username
    ...
    // theme and language
    public static $theme = 'revolution'; // can be 'default', 'bootstrap', 'minimal', 'revolution' or your custom. Theme of xCRUD visual presentation. Revolution theme features glassmorphism and modern animations.
    ...
    public static $alt_lifetime = 90; // in minutes, maximum time between requests when instance's data can be valid
