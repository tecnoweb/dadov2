...
<body>
  <body>
<h1><span style="color: #ffffff; font-size:25px;">Registrazione</span></h1>		
<br>
	...
	<?php
		if(config::get('allow_signup'))
		{
			...
			<div class="form-group">
				<input type="text" class="form-control" name="txt_uname" placeholder="Nome Utente " required="" id="username" />
			</div>
			<div class="form-group">
