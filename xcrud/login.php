...
<h1><span style="color: #ffffff; font-size:25px;">Rocket CRUD </span></h1>		
<br>
...
<div id="error">
	...
	?>
			...
			<div class="form-group">
				<input type="text" class="form-control" name="txt_uname_email" placeholder="Nome Utente" required="" id="username" />
			</div>
