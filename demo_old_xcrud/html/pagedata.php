...
$pagedata = array(
    'default' => array(
        'title_1' => 'xCrudRevolution Home',
        'description' => 'Welcome to the next generation of xCrud - featuring multi-database support, advanced operators, and modern architecture',
        'filename' => 'home_revolution.php'),
    'simple_usage' => array(
    ...
    'callbacks' => array(
        'title_1' => 'Callbacks & Hooks',
        'description' => 'Complete lifecycle hooks system - before/after/replace callbacks for all operations',
        'filename' => 'callbacks.php'),
    'mass_operations' => array(
        'title_1' => 'Mass Operations',
        'description' => 'Bulk actions and mass operations - select multiple rows and perform batch operations',
        'filename' => 'mass_operations.php'),
    'custom_buttons' => array(
        'title_1' => 'Custom Buttons',
        'description' => 'Add custom buttons with links, JavaScript actions, and conditional display',
        'filename' => 'custom_buttons.php'),
